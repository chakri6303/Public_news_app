...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_registerBtn = findViewById(R.id.tvb_registerButton);
        spinnerRoleLogin = findViewById(R.id.spinner_role);
        ...
        spinnerRoleLogin.setAdapter(adapter);
    ...
    private void performLogin() {
        ...
        String selectedRole = spinnerRoleLogin.getSelectedItem().toString();
